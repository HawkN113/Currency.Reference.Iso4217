...
public class LocalDatabaseGenerator : BaseIncrementalGenerator
{
    ...
    private void GenerateSourceOutput((string originalJson, string replacementJson, string historicalJson) tuple,
        ...
        bool isHistorical = false)
    {
        ...
        sb.AppendLine(
                $"        public static IReadOnlyList<Models.Currency> {propertyName} = new List<Models.Currency>()")
            .AppendLine("        {");
