...
[![CodeQL Security](https://img.shields.io/github/actions/workflow/status/HawkN113/Currency.Reference.Iso4217/codeql-analysis.yml?label=CodeQL%20Security&style=flat-square)](https://github.com/HawkN113/Currency.Reference.Iso4217/actions/workflows/codeql-analysis.yml)
...
| Package                                                                                           | Description |
|---------------------------------------------------------------------------------------------------|-------------|
| [HawkN.Currency.Reference.Iso4217](https://www.nuget.org/packages/HawkN.Currency.Reference.Iso4217) | Main library with domain models, currency utilities, and generated `CurrencyCode` type. |
---
